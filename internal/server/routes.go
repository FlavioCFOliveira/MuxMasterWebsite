...
func docRoutes() []route {
	...
	return []route{
		...
		{path: "/benchmarks", title: "Benchmarks", description: "Benchmark numbers from the upstream MuxMaster suite, quoted verbatim with source-file citations. Static lookups at 25 ns; one-parameter at 112 ns.", upstreamURL: ghRoot + "bench_test.go", hasMarkdown: true, contentPath: "benchmarks.md", cache: cacheControlDocs, section: "benchmarks", ogType: "article"},
