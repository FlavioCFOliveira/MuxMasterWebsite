...
func docRoutes() []route {
	...
	return []route{
		...
		{path: "/examples/", title: "Examples", description: "Thirteen runnable examples covering REST APIs, the v1.1.0 maximum-performance hot path, API versioning, server-sent events, file uploads, reverse proxying, authentication (Basic / JWT / OAuth2), caching, graceful shutdown, server-side rendering, and static sites.", upstreamURL: "https://github.com/FlavioCFOliveira/MuxMaster/tree/main/examples", hasMarkdown: false, contentPath: "", cache: cacheControlLanding, section: "examples", ogType: "article"},
		...
		{path: "/examples/max-performance", title: "Maximum-performance example", description: "Every v1.1.0 opt-in stacked together: PoolRequestBundle, PoolFastParams, Pre, Use, HandleFast, UseFast, and a Mounted net/http/pprof tree. Includes an in-process /bench endpoint that measures the live speed-up on the user's hardware and returns JSON with the 2.4x pool win.", upstreamURL: "https://github.com/FlavioCFOliveira/MuxMaster/tree/main/examples/max-performance", hasMarkdown: true, contentPath: "examples/max-performance.md", cache: cacheControlDocs, section: "examples", ogType: "article", order: 2},
