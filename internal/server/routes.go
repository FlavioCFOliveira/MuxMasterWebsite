...
func docRoutes() []route {
	...
	return []route{
		...
		{path: "/docs/routing", title: "Routing", description: "Define static and parametric routes, pattern syntax, and match precedence on the MuxMaster radix tree.", upstreamURL: ghDocs + "routing.md", hasMarkdown: true, contentPath: "docs/routing.md", cache: cacheControlDocs, section: "docs", ogType: "article"},
		{path: "/docs/groups", title: "Groups", description: "Compose route prefixes, scoped middleware, and nested groups with mux.Group.", upstreamURL: ghDocs + "groups.md", hasMarkdown: true, contentPath: "docs/groups.md", cache: cacheControlDocs, section: "docs", ogType: "article"},
		{path: "/docs/middleware", title: "Middleware", description: "Built-in middleware: Recoverer, RequestID, Logger, Compress, RealIP, Timeout, Throttle, BasicAuth, JWTAuth, OAuth2Introspect, APIKey, CORS, SetHeader.", upstreamURL: ghDocs + "middleware.md", hasMarkdown: true, contentPath: "docs/middleware.md", cache: cacheControlDocs, section: "docs", ogType: "article"},
		{path: "/docs/error-handling", title: "Error handling", description: "HandlerFuncE and the typed error pipeline. How errors are surfaced, logged, and rendered.", upstreamURL: ghDocs + "error-handling.md", hasMarkdown: true, contentPath: "docs/error-handling.md", cache: cacheControlDocs, section: "docs", ogType: "article"},
		...
		{path: "/docs/response-helpers", title: "Response helpers", description: "JSON, Text, NoContent, and the typed parameter accessors that read URL params without reflection.", upstreamURL: ghDocs + "response-helpers.md", hasMarkdown: true, contentPath: "docs/response-helpers.md", cache: cacheControlDocs, section: "docs", ogType: "article"},
		{path: "/docs/performance", title: "Performance", description: "Allocation profile, FastHandler, the radix-tree lookup cost model, and the benchmarks that back the numbers.", upstreamURL: ghDocs + "performance.md", hasMarkdown: true, contentPath: "docs/performance.md", cache: cacheControlDocs, section: "docs", ogType: "article"},
		...
		{path: "/docs/migration", title: "Migration", description: "Mapping idioms from net/http, gorilla/mux, chi, gin, and httprouter onto MuxMaster.", upstreamURL: ghDocs + "migration.md", hasMarkdown: true, contentPath: "docs/migration.md", cache: cacheControlDocs, section: "docs", ogType: "article"},
		...
		{path: "/examples/", title: "Examples", description: "Eight runnable examples covering REST APIs, authentication, JWT, OAuth2, caching, graceful shutdown, server-side rendering, and static sites.", upstreamURL: "https://github.com/FlavioCFOliveira/MuxMaster/tree/main/examples", hasMarkdown: true, contentPath: "", cache: cacheControlLanding, section: "examples", ogType: "article"},
		{path: "/examples/rest-api", title: "REST API example", description: "A small REST API built with MuxMaster: route grouping, JSON responses, and parameter parsing.", upstreamURL: "https://github.com/FlavioCFOliveira/MuxMaster/tree/main/examples/rest-api", hasMarkdown: true, contentPath: "examples/rest-api.md", cache: cacheControlDocs, section: "examples", ogType: "article"},
		{path: "/examples/authn", title: "Authentication example", description: "Username and password authentication with the BasicAuth middleware.", upstreamURL: "https://github.com/FlavioCFOliveira/MuxMaster/tree/main/examples/authn", hasMarkdown: true, contentPath: "examples/authn.md", cache: cacheControlDocs, section: "examples", ogType: "article"},
		{path: "/examples/jwt", title: "JWT example", description: "Bearer-token authentication with the JWTAuth middleware and required-expiry hardening.", upstreamURL: "https://github.com/FlavioCFOliveira/MuxMaster/tree/main/examples/jwt", hasMarkdown: true, contentPath: "examples/jwt.md", cache: cacheControlDocs, section: "examples", ogType: "article"},
		{path: "/examples/oauth2", title: "OAuth2 example", description: "OAuth2 token introspection with the OAuth2Introspect middleware.", upstreamURL: "https://github.com/FlavioCFOliveira/MuxMaster/tree/main/examples/oauth2", hasMarkdown: true, contentPath: "examples/oauth2.md", cache: cacheControlDocs, section: "examples", ogType: "article"},
		{path: "/examples/cache", title: "Cache example", description: "HTTP caching headers and a small in-process response cache.", upstreamURL: "https://github.com/FlavioCFOliveira/MuxMaster/tree/main/examples/cache", hasMarkdown: true, contentPath: "examples/cache.md", cache: cacheControlDocs, section: "examples", ogType: "article"},
		{path: "/examples/graceful-shutdown", title: "Graceful shutdown example", description: "Signal-driven srv.Shutdown with a bounded drain deadline and the recommended timeout set.", upstreamURL: "https://github.com/FlavioCFOliveira/MuxMaster/tree/main/examples/graceful-shutdown", hasMarkdown: true, contentPath: "examples/graceful-shutdown.md", cache: cacheControlDocs, section: "examples", ogType: "article"},
		{path: "/examples/server-side-render", title: "Server-side render example", description: "html/template-based server-side rendering with MuxMaster.", upstreamURL: "https://github.com/FlavioCFOliveira/MuxMaster/tree/main/examples/server-side-render", hasMarkdown: true, contentPath: "examples/server-side-render.md", cache: cacheControlDocs, section: "examples", ogType: "article"},
		{path: "/examples/static-site", title: "Static site example", description: "Serving a static site with MuxMaster's ServeFiles primitive.", upstreamURL: "https://github.com/FlavioCFOliveira/MuxMaster/tree/main/examples/static-site", hasMarkdown: true, contentPath: "examples/static-site.md", cache: cacheControlDocs, section: "examples", ogType: "article"},

		{path: "/benchmarks", title: "Benchmarks", description: "Benchmark numbers quoted verbatim from the upstream MuxMaster benchmark suite, with source-file citations.", upstreamURL: ghRoot + "bench_test.go", hasMarkdown: true, contentPath: "benchmarks.md", cache: cacheControlDocs, section: "benchmarks", ogType: "article"},
		{path: "/changelog", title: "Changelog", description: "Full upstream changelog: every released version of MuxMaster, with one section per release.", upstreamURL: ghRoot + "CHANGELOG.md", hasMarkdown: true, contentPath: "changelog.md", cache: cacheControlChangelog, section: "changelog", ogType: "article"},
		{path: "/releases/v1.0.0", title: "Release notes — v1.0.0", description: "Release notes for MuxMaster v1.0.0 (the first general-availability release).", upstreamURL: ghRoot + "release-notes/v1.0.0-20260508.md", hasMarkdown: true, contentPath: "release-notes/v1.0.0.md", cache: cacheControlRelease, section: "releases", ogType: "article"},
		...
		{path: "/compatibility", title: "Compatibility", description: "Supported Go versions, semantic-versioning guarantees, and net/http interoperability.", upstreamURL: ghRoot + "COMPATIBILITY.md", hasMarkdown: true, contentPath: "compatibility.md", cache: cacheControlDocs, section: "compatibility", ogType: "article"},
		{path: "/contributing", title: "Contributing", description: "How to contribute to MuxMaster: branch policy, tests, security review, and the gatekeeper-agent workflow.", upstreamURL: ghRoot + "CONTRIBUTING.md", hasMarkdown: true, contentPath: "contributing.md", cache: cacheControlDocs, section: "contributing", ogType: "article"},
	}
}
